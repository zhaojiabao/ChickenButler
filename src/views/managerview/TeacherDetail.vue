<template>
	...
	<div class="teacher-detail">
		<div class="cover-name" v-for="(tea,index) in teacher_detail">
		...
		<div class="teacher-class">
			...
			<div class="main" v-for="(cla,index) in teacher_class" @click="claClick(cla.v_id)">
	...
	export default {
		...
		mounted() {
			...
			getOneTeachVideo({
				...
				//console.log(this.teacher_detail)
				this.$wechat.ready(() => {
					var title = res.data.info[0].descript;
					var link = window.location.href;
					var imgUrl = res.data.info[0].cover;
