	...
	<div class="cricle-detail">
		<div class="circle-main-warp">
			<div class="circle-main" @click="delClick(data_circle.id)">
				...
				<span v-if="data_circle.is_circle==1"><img class="circle-main-img" src="../../assets/jiantou.png" alt="" /></span>
				...
				<div class="forum-main">
					...
					<div class="forum-main-right">
						...
						<p class="cover" v-show="forum.cover.length > 0">
							<img :src="cov" v-for="(cov,index) in forum.cover" v-if="index<3" />
						</p>
						<div class="ask-egg" v-if="forum.type==2">
							<span>提问积蛋: {{forum.prize_scores}}枚</span><span class="ask" v-if="forum.is_adopt==0">提问中</span><span class="finish" v-else>已解决</span>
						</div>
		...
		<popup v-model="post" height="100%">
			...
			<template v-if="data_circle.is_circle==1">
				<div class="post-type">
