<template>
	...
	<div class="pm_autumn">
		<!--头部图片  start-->
		<div class="head">
			<img src="https://m.danjiguanjia.com/active/ative-autumn-head.png" />
		</div>
		<!--头部图片  end-->
		<!--活动说明 start-->
	...
	export default {
		...
		mounted() {
			...
			getGoods().then(rs => {
				...
				console.log(rs.data)
				this.goodsList[2].image='https://bg.danjiguanjia.com/public/uploads/20171110/b2eba66c3247d3d409816a30d3b829d0.png'
				this.goodsList[6].image='https://bg.danjiguanjia.com/public/uploads/20171110/68d40e5ea7a76d06ae40c7dd481fbe22.png'
			})
...
<style lang="less" scoped="scoped">
	...
	.pm_autumn {
	background-image: url(https://m.danjiguanjia.com/active/bg.jpg);
