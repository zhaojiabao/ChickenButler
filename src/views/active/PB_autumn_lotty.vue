<template>
	...
	<div class="pm_autumn">
		<!--头部图片  start-->
		<div class="head">
			<img src="https://m.danjiguanjia.com/images/ative-autumn-head.png" />
		</div>
		<!--头部图片  end-->
		<!--活动说明 start-->
...
<script>
	...
	import { getGoods, getUserPrize, addScores, addPrize_autumn, getPrize, getRecordLog } from '../../api/BeneActive'
	export default {
		directives: {
			TransferDom
		},
...
<style lang="less">
	...
	.pm_autumn {
		background-image: url(https://m.danjiguanjia.com/images/ative-autumn-bg.jpg);
