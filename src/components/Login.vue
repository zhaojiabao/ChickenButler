<template>
	...
	<div class="login">
		...
		<div class="content">
			...
			<group v-show="is_regist" style='position: relative;'>
				...
				<x-input placeholder="请输入验证码" v-model="user.code">
					<!--<x-button slot="right" type="primary" plain mini @click.native="getCode" style='background-color: #57B663;font-size: 16px;'>{{ btn_msg }}</x-button>-->
			...
			<div class="note of" v-show="!is_regist">
				...
				<router-link tag="span" to="/p/findpassword">
					<div class="r">
						找回密码
					</div>
				</router-link>
			...
			<div class="weixin">
				<a href="http://app.jianong.com/wxlogin/m"><img src="../assets/weixin.png" alt="" /></a>
				<!--<a href="https://app.danjiguanjia.com/#/p/sanlogin"><img src="../assets/weixin.png" alt="" /></a>-->
			</div>
			<div class="bottom">
			...
			onLogin() {
				...
				userLogin({
					...
					if(rs.retcode == 2000) {
						...
						localStorage.setItem('ticket', rs.data.ticket);
						//跳转回来源页
						if(this.$store.state.source_url_name == "Login") {
							if(document.referrer.indexOf('.html')) {
